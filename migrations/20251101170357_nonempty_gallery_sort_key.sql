...
CREATE TABLE tmp (
  ...
  sort_key BLOB NOT NULL CHECK(LENGTH(sort_key) > 0),
...
INSERT INTO tmp SELECT gallery_id, project_id, sort_key, filename, description, published_at, published_by FROM galleries;
